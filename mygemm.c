...
for(i = 0; i < n; i+=3){
	for(j = 0; j < n; j+=3){
		...
		for(k = 0; k < n; k+=3){
			//using 3 double registers to hold three row elements of first column for A and three column elements of first row for B
			...
			register double b00 = B[tb]; register double b01 = B[tb+1]; register double b02 = A[tb+2];
